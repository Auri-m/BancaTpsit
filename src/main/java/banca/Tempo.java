...
public class Tempo extends JFrame {
	...
	public Tempo(String filePath) {
		...
		confirmButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				action(filePath, panel, mesiString, settimana, portafoglio, contoCorrente);
			}
		});
	}
	 ...
	 *                      messaggi
	 * @param mesiString    -- Variabile che contiene la stringa inserita
	 *                      dall'utente nel campo dateField
	 ...
	 */
	private void action(String filePath, JPanel panel, String mesiString, int settimana, double portafoglio,
